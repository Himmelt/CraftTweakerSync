...
@Mod(
        modid = CraftTweakerSync.MODID,
        name = CraftTweakerSync.NAME,
        version = CraftTweakerSync.VERSION,
...
public class CraftTweakerSync {
    ...
    @SidedProxy(
            clientSide = "com.porpit.crafttweakersync.client.ClientProxy",
            serverSide = "com.porpit.crafttweakersync.common.CommonProxy"
    )
